...
int main(int argc, char *argv[])
{
    ...
    scanf("%d", &thread_count); //get user input of threads

    pthread_t threads[thread_count]; // create 'thread_count'
    ...
    for (i = 0; i < N; i++)
    {
        pthread_create(&threads[i % thread_count], NULL, ge, (void *)i);
    }
